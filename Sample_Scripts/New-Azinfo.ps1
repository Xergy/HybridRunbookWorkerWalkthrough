...
Switch ($ConfigLabel) {
    ...
    HRW{
        $Subs = Get-AzSubscription -Subscriptionid "3ba3ebad-7974-4e80-a019-XXXXXXXX"
        Write-Output "Subs"
        $Subs
        Set-AzContext -SubscriptionId 3ba3ebad-7974-4e80-a019-XXXXXXXX | Out-Null
        ...
        $ScriptControl = @{
            ...
            ExportAzInfoToBlobStorage = @{
                ...
                Params = @{    
                    LocalPath = $TempPath
                    StorageAccountSubID = $Subs.SubscriptionId
                    StorageAccountRG = "hrwrg"        
                    StorageAccountName =  "hrwsa"       
                    StorageAccountContainer = "azinfo"
                }
            }
        } # End ScriptControl Prod
