...
2.0 - 3/29/2020
 -- MODIFIED BY Raffe Felts raffe@microsoft.com
 -- Updated to AZ commands, removed some Auth Madness
...
1.5 - 5/29/2018
 ...
 -- updated use of New-AZOperationInsightsWorkspace cmdlet to user the "PerNode" SKU
...
$Account = Get-AzContext @paramsplat 
